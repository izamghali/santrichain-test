...
export default function ProductMobileSortFilter({ selectedSortOption, setSelectedSortOption }: { selectedSortOption: string, setSelectedSortOption:any }) {
    return (
        <>
        <Sheet>
            ...
            <SheetContent className="lg:hidden space-y-4" side={'bottom'}>
                <div>
                ...
                <ProductSortMenu selectedSortOption={selectedSortOption} setSelectedSortOption={setSelectedSortOption} />
            </SheetContent>
        </Sheet>
        </>
    )
